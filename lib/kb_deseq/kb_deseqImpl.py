...
class kb_deseq:
    ...
    ######################################### noqa
    VERSION = "1.0.4"
    GIT_URL = "https://github.com/JamesJeffryes/kb_deseq.git"
    GIT_COMMIT_HASH = "357ee87fe2817ac7b088338cb9987ab3e09e485a"
    ...
    def run_deseq2_app(self, ctx, params):
        ...
        :param params: instance of type "DESeqInput" (required params:
           ...
           cutoff input_type: one of ["genes", "transcripts"] num_threads:
           number of threads fold_scale_type: one of ["linear", "log2+1",
           "log10+1"]) -> structure: parameter "expressionset_ref" of type
           "obj_ref" (An X/Y/Z style reference), parameter
           "differential_expression_set_suffix" of String, parameter
           "workspace_name" of String, parameter "run_all_combinations" of
           type "boolean" (A boolean - 0 for false, 1 for true. @range (0,
           1)), parameter "condition_labels" of list of String, parameter
           "alpha_cutoff" of Double, parameter "fold_change_cutoff" of
           Double, parameter "input_type" of String, parameter "num_threads"
           of Long, parameter "fold_scale_type" of String
