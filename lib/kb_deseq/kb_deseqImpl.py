...
class kb_deseq:
    ...
    GIT_COMMIT_HASH = "726c448cc559d51215d637408314ff930177c293"
    ...
    def run_deseq2_app(self, ctx, params):
        ...
        :param params: instance of type "DESeqInput" (required params:
           ...
           gets saved to optional params: fold_scale_type: one of ["linear",
           "log2+1", "log10+1"] alpha_cutoff: q value cutoff
           fold_change_cutoff: fold change cutoff maximum_num_genes: maximum
           gene numbers) -> structure: parameter "expressionset_ref" of type
