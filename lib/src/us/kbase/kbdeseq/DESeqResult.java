...
public class DESeqResult {
    ...
    public DESeqResult withFilteredExpressionMatrixRef(String filteredExpressionMatrixRef) {
        this.filteredExpressionMatrixRef = filteredExpressionMatrixRef;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((("DESeqResult"+" [resultDirectory=")+ resultDirectory)+", diffExpressionObjRef=")+ diffExpressionObjRef)+", filteredExpressionMatrixRef=")+ filteredExpressionMatrixRef)+", reportName=")+ reportName)+", reportRef=")+ reportRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
