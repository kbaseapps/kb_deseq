...
/**
 * <p>Original spec-file module name: kb_deseq</p>
 * <pre>
 * A KBase module: kb_deseq
 * </pre>
 */
public class KbDeseqClient {
     ...
     * validity.
     */
    public KbDeseqClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbDeseqClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbDeseqClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
     ...
     * @return   parameter "returnVal" of type {@link us.kbase.kbdeseq.DESeqResult DESeqResult}
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_deseq.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
